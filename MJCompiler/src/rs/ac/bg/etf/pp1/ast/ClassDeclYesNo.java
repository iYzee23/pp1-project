...
public class ClassDeclYesNo extends ClassDecl {
    ...
    public ClassDeclYesNo (String I1, Type Type, StatVarDeclList StatVarDeclList, StatInitList StatInitList, VarDeclList VarDeclList) {
        this.I1=I1;
        this.Type=Type;
